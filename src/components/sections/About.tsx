...
const values = [
  {
    ...
    description:
      'Enfoque analítico y dominio tecnológico para aplicar conocimiento con rigor en contextos de alta complejidad.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Detecto lo oculto, analizo con visión de futuro y anticipo tendencias para decisiones sostenibles.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="about" className="py-20 bg-[var(--gray-light)]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <AnimateOnScroll className="text-center mb-16">
          <p className="text-[var(--teal)] font-semibold mb-2">SOBRE MÍ</p>
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--gray-dark)]">
            Del físico al CEO: una trayectoria global
          </h2>
        </AnimateOnScroll>
          ...
          <AnimateOnScroll direction="right" delay={0.1}>
            <div>
              <p className="text-lg text-[var(--gray-medium)] mb-6 leading-relaxed">
                ...
                físico de formación, MBA y fundador de{' '}
                <strong className="text-[var(--teal)]">BEAI Energy</strong>. Mi carrera
                ha sido un viaje de transformación constante: desde las ecuaciones de la
                física hasta liderar equipos de más de 2.000 personas en empresas
                multinacionales.
              </p>
              <p className="text-lg text-[var(--gray-medium)] mb-6 leading-relaxed">
                He trabajado en <strong className="text-[var(--gray-dark)]">más de 25 países</strong>,
                conectando culturas, equipos y visiones empresariales. Esta experiencia
                multicultural me ha enseñado que la verdadera transformación no es solo
                tecnológica, es <em>profundamente humana</em>.
              </p>
              <p className="text-lg text-[var(--gray-medium)] mb-8 leading-relaxed">
                Hoy, desde BEAI Energy, tengo una misión clara:{' '}
                <strong className="text-[var(--teal)]">
                  que la inteligencia artificial amplifique lo mejor de nosotros,
                  sin reemplazarnos
                </strong>.
                Creo en la tecnología con propósito, en el progreso con conciencia.
              </p>
              ...
              <blockquote className="border-l-4 border-[var(--gold)] pl-6 py-2 mb-8 bg-white rounded-r-lg">
                <p className="text-xl italic text-[var(--gray-dark)]">
                  "Más allá de lo artificial. Genuinamente humano."
                </p>
              </blockquote>
